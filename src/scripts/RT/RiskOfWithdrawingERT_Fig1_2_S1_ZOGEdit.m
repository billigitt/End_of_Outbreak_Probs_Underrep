...
%NB: This code is identical to RiskOfWithdrawingERT_Fig1_2_S1.m except a
%small correction was made to that code, so that we can check this with our
%own code to see if the results are equivalent. By typing
%'save('../../mats/varsFig1_2_S1_ZOGEdit.mat')' after this code has finished
%running, the user can generate the .mat file used in recreateRT.m.
